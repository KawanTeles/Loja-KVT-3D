...
const PRODUTOS = [
    ...
    },
    {
        ...
        descricao: "Chocalho sensorial para estimulação.",
    ...
    },
     {
        ...
        precoAtacado: 55.00,
        categoria: "brinquedos-sensoriais",
        descricao: "Brinquedo sensorial tabuada.",
    ...
    },
     {
        ...
        descricao: "Brinquedo giroscópico.",
...
document.addEventListener('DOMContentLoaded', () => {
    ...
    initMulticolorAnimation(); // Chamada inicial
});
...
function displayProducts(products, container) {
    ...
    container.innerHTML = products.map(p => {
        ...
        // Aplica classe de efeito no nome se for Multicolor
    ...
    initMulticolorAnimation(); // Aplica animação aos itens injetados
}
...
function buyOnWhatsApp(id) {
    ...
    const msg = encodeURIComponent(`Olá! Tenho interesse no: ${p.nome}`);
...
function initFormularioContato() {
    ...
    form.addEventListener('submit', (e) => {
        e.preventDefault();
        window.open(`https://wa.me/55829983439617`, '_blank');
    });
}

// 11. ANIMAÇÃO MULTICOLOR (PADRONIZADA)
